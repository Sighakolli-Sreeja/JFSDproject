...
.cards-container {
    background: url("img/photo7.png") no-repeat center center fixed;
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/bluee.jpg" class="card-img-top" alt="Enterprise Programming">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/grey.jpg" class="card-img-top" alt="Database Management Systems">
                    <div class="card-body">
                        <p class="card-text" style="font-size: 24px;"><strong>Database Management Systems</strong></p>
                        <p class="card-text" style="font-size: 16px;"><strong>22AD2102R</strong></p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/brown.jpg" class="card-img-top" alt="Adaptive Software Engineering">
                    <div class="card-body">
                        <p class="card-text" style="font-size: 24px;"><strong>Adaptive Software Engineering</strong></p>
                        <p class="card-text" style="font-size: 16px;"><strong>22CI2001</strong></p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/purplee.jpg" class="card-img-top" alt="Operating Systems">
                    <div class="card-body">
                        <p class="card-text" style="font-size: 24px;"><strong>Operating Systems</strong></p>
                        <p class="card-text" style="font-size: 16px;"><strong>22CS2104R</strong></p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/green.jpg" class="card-img-top" alt="Java Full Stack Development">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 text-center">
                    <img src="img/red.jpg" class="card-img-top" alt="Design Analysis & Algorithms">
                    <div class="card-body">
